      ...
      <ul className="works-list">
        ...
        <li className="works-item">
          ...
          <p className="description">
            フロイトによると、人間の内面は、超自我と自我そして無意識で構成されている。超自我とは、社会的体裁や立場などの要因によって形成される、外的に理想な像である。一方、無意識とは、欲求や感情といった、人間が本来持つ内面から湧き上がる事象である。人間の自我とは、この超自我と無意識に折り合いをつけるように作用し、自我によって人は思考し行動する。これらは常に作用しあっており、超自我と無意識のバランスを保つ必要がある。
            超自我の作用が大きくなり、無意識が抑圧されると、自身の感情や欲求が排除され、長期的にその状態が続けば不健全な形で感情や欲求が現れる（図左側）。
            一方、無意識の作用が大きくなり、超自我が抑圧されると、社会的信頼を失い、いわゆる不適合者に陥ってしまう。
          ...
          <p className="description">
          ケン・ウィルバーによるインテグラル理論によると、人間の自我は成長とともに発達する。自我の成長とともに、自身の能力や性格特性といった要素の用い方が変化する。例えば、順応的段階においては、自身が所属する集団と自己のアイデンティティを同一化しているために、所属する集団において善とされることに盲目的に従う。しかし、自意識的段階においては、孤立した自己としてのアイデンティティを確立しようとするため、集団とは異なる意見、行動をあえて取ることで、自他に自身が周囲と異なる存在であることを暗示しようとするのである。このような自我の成長を垂直的発達といい、一方で能力や性格特性といった要素は垂直的成長と呼ぶ。現代においては、水平的成長が重視されることが多いが、垂直的成長がなければ、本質的な成長とは言えない。
          </p>
          <h3 className="used-techs">
            ■参考文献
          </h3>
