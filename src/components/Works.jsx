    ...
    <div id="twoD-content" className='works'>
      ...
      <ul className="works-list">
        <li className="works-item">
          ...
          「家族や恋人にプレゼントを選ぶのって難しい！」、「自分が本当に欲しいものを見つけるのって難しい！」そんな思いを解決るすために、「Hosh!」は誕生した。今の自分の欲求を投稿することで、他ユーザーやLLMからほしい物をおすすめしてくれる。また、欲しいものリストを共有することで、プレゼント選びの参考にできる。「ほしい」をキーワードにユーザ間でのインタラクティブな環境を提供。
          </p>
        ...
        <li className="works-item">
          ...
          <p className="description">
          2022年6月、株式会社RIWBを設立し代表取締役社長に就任。自律したシンクタンクの実現を最終目標に掲げ、不動産検索サイトの共同開発やシステム案件受注を行う。福岡市の不動産データを分析し、賃貸相場に加え、長期的な賃貸と購入の場合の価格比較や周辺の教育環境を網羅的に検索できるアプリケーション開発を共同開発。同年12月、退社。
          </p>
